...
/*ElementFactory.prototype.createAlternativeDataObjectShape = function() {
  return this.createShape({
    type: 'ds:AlternativeDataObjectReference',
    businessObject: this._bpmnFactory.createAlternativeDataObject()
  });
};*/
