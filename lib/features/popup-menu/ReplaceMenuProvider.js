...
ReplaceMenuProvider.prototype._getDataObjectIsCollection = function(element) {
  ...
  if(dataObject.boss==1) {
    ...
    if(dataObject.isInput == undefined || !dataObject.isInput) {
  ...
  if(dataObject.boss==1) {
    ...
    if(dataObject.isOutput == undefined || !dataObject.isOutput) {
  ...
  function noAlternative(event,entry) {
    ...
    if(getBusinessObject(element).noAlternative == 0 || getBusinessObject(element).noAlternative === undefined) {
              ...
              if(businessObject.boss==1 || businessObject.boss==undefined) {
                ...
                businessObject.noAlternative=1;
              ...
              var elements = elementRegistry.filter(function(element) {
                ...
                if(businessObject.boss==1 || businessObject.boss==undefined) {
                  ...
                  businessObject.noAlternative=0;
...
if(element.businessObject.available==1 && (element.businessObject.boss==1 || element.businessObject.boss==undefined)) {
